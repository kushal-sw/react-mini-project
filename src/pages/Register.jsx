...
export default function Register({ onRegister, onLoginClick }) {
  ...
  // ✅ Google Sign-Up: block if account already exists
  ...
  // ✅ Email/Password Sign-Up: wired to state + proper error handling
    ...
    <div className="flex min-h-screen bg-[#111111] text-white font-sans">
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-24 relative">
        <Card className="mx-auto w-full max-w-[360px] bg-transparent border-none text-white shadow-none">
          <CardHeader className="text-center mb-6 p-0">
            ...
            <CardDescription className="text-sm text-gray-400">
              Join us to discover your next favourite meal.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4 p-0">
            <div className="flex gap-4">
              <Button
                ...
                variant="outline"
                className="w-full bg-transparent border-[#2a2a2a] text-sm font-normal text-white hover:bg-[#2a2a2a] hover:text-white h-10"
              >
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-[#111111] px-3 text-gray-500 uppercase">
                  OR
                </span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {/* ✅ Error message */}
              {error && (
                <p className="text-red-400 text-xs text-center bg-red-400/10 border border-red-400/20 rounded-md px-3 py-2">
                  {error}
                </p>
              )}
              ...
              <ButtonColorful
                onClick={handleEmailRegister} // ✅ was calling onRegister directly before
          ...
          <CardFooter className="flex-col mt-8 text-center text-xs text-gray-400 space-y-3 p-0">
            <p>
              ...
              <button
                ...
                className="text-gray-300 hover:text-white border-b border-gray-600 hover:border-gray-300 pb-[1px]"
              >
                Log in
              </button>
            </p>
        ...
        <div className="absolute bottom-6 right-6 lg:right-12 text-xs text-gray-500">
          ...
          <a
            href="#"
            className="hover:text-gray-300 border-b border-transparent hover:border-gray-400 pb-[1px]"
          >
            Terms of Service
          </a>{" "}
          and{" "}

      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-24 relative">
        <Card className="mx-auto w-full max-w-[360px] bg-transparent border-none text-white shadow-none">
          <CardHeader className="text-center mb-6 p-0">
            <CardTitle className="text-2xl font-semibold tracking-tight text-white mb-2">Create an account</CardTitle>
            <CardDescription className="text-sm text-gray-400">Join us to discover your next favourite meal.</CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex-col mt-8 text-center text-xs text-gray-400 space-y-3 p-0">
            <p>
              Already have an account? <button onClick={onLoginClick} className="text-gray-300 hover:text-white border-b border-gray-600 hover:border-gray-300 pb-[1px]">Log in</button>
            </p>
          </CardFooter>
        </Card>
        ...
        <div className="absolute bottom-6 right-6 lg:right-12 text-xs text-gray-500">
          By registering, you agree to our <a href="#" className="hover:text-gray-300 border-b border-transparent hover:border-gray-400 pb-[1px]">Terms of Service</a> and <a href="#" className="hover:text-gray-300 border-b border-transparent hover:border-gray-400 pb-[1px]">Privacy Policy</a>.
        </div>
      </div>
    </div>
  );
